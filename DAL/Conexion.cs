...
namespace DAL
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=MIZADLO-PC\MIZADLO;Initial Catalog=PacientesDB;Integrated Security=True;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False");
        /// <summary>
